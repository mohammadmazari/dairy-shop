...
import myorders from "../../animation/my-orders.json";
function Myorders() {
  ...
  return (
    <Myprofile>
      <div className="m-auto w-full mt-10 md:mt-0 md:inline-flex md:w-[80%] h-auto  border p-2 md:p-10 md:flex-col md:gap-10 font-ycan">
        ...
        <div className="flex  px-20 justify-center  bg-gray-100 rounded py-10 my-5 flex-col items-center ">
          <div className="text-center">
            <p className="text-[0.7rem] md:text-[1rem] text-gray-500">
              سفارش فعلی در این بخش وجود ندارد
            </p>
            <Lottie
              loop
              play
              animationData={myorders}
