...
export default function Modalexpress({ name }) {
  ...
  return (
    <React.Fragment>
      ...
      >
        <div className="w-full sm:w-[550] p-2 text-sm sm:text-md font-vazir ">
          ...
          <div className="px-2 sm:px-10 text-justify">
            <div>
              ...
              <p className="text-[0.7rem]  sm:text-sm mt-3 font-extralight">
              ...
              <ul className="text-[0.7rem]  sm:text-sm list-disc  font-medium px-4 mt-4">
              ...
              <p className="text-[0.7rem]  sm:text-sm   mt-3 font-light">
